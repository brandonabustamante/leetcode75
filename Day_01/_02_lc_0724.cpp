...
int main()
{
    ...
    std::vector<int> test_1 = {1, 7, 3, 6, 5, 6};
    std::vector<int> test_2 = {1, 2, 3};
    std::vector<int> test_3 = {2, 1, -1};

    std::cout << pivotIndex(test_1) << "\n";
    std::cout << pivotIndex(test_2) << "\n";
    std::cout << pivotIndex(test_3) << "\n";
}